...
class FBMarketplaceScraper:
   ...
   def clasify_multi_list_data(self,multi_products):
      ...
      for product in multi_products:
         ...
         description = multi_product_elements.text.lower()
      ...
      return extract_multi_list_data , all_html_multi_content

   def process_multi_list_data(self,all_html_multi_content): # may find more effien way to do it 
      extract_multi_list_data_2 = []
      for product in all_html_multi_content:
         ...
         extract_multi_list_data_2.append({
               "title": title,
               "price": price,
               "location": location,
               "url": re.sub(r"\?.*", "", url)
         })
         return extract_multi_list_data_2 

   def save_to_csv(self, data_1 , data_2 , data_3):
...
data_1 = scraper.process_single_list_data(products)[0]
data_2 = scraper.clasify_multi_list_data(products)[1]
data_3 = scraper.process_multi_list_data(data_2)[1]
scraper.save_to_csv(data_1,data_2,data_3)
